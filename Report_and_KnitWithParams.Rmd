...
author: "Author: Claudiu Papasteri"
date: "`r format(Sys.Date(), '%d/%m/%y')`"
output:
  rmdformats::readthedown:
    highlight: kate
# Trick to set output_dir without calling rmarkdown::render(), but RStudio Knit with Params is substituted by Shiny in browser
knit: (function(inputFile, encoding) {         
  rmarkdown::render(inputFile, encoding = encoding, output_dir = "docs", params = "ask", runtime = "shiny", output_format = "all") })
params:
  region: 
    label: "Region:"
    value: Mountain
